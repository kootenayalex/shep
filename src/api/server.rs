...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::SessionOverview(_) => "session.overview",
        ...
        Method::DocketList(_) => "docket.list",
        Method::DocketAdd(_) => "docket.add",
        Method::DocketUpdate(_) => "docket.update",
        Method::DocketPromote(_) => "docket.promote",
        Method::DocketComplete(_) => "docket.complete",
        Method::DocketDiscard(_) => "docket.discard",
        Method::OverseerSample(_) => "overseer.sample",
        Method::OverseerChat(_) => "overseer.chat",
        Method::OverseerTick(_) => "overseer.tick",
        ...
        Method::AgentSetState(_) => "agent.set_state",
        Method::AgentClearState(_) => "agent.clear_state",
