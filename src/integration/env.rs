...
pub(crate) const SHEP_PANE_ID_ENV_VAR: &str = "SHEP_PANE_ID";
pub(crate) const SHEP_TAB_ID_ENV_VAR: &str = "SHEP_TAB_ID";
pub(crate) const SHEP_WORKSPACE_ID_ENV_VAR: &str = "SHEP_WORKSPACE_ID";
