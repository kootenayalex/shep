    ...
    let mut messages = match target {
        ...
        crate::api::schema::IntegrationTarget::Droid => {
            ...
            if installed.updated_legacy_hooks {
                messages.push(format!(
                    "removed legacy shep droid hook entries from {}",
    ...
    let messages = match target {
        ...
        crate::api::schema::IntegrationTarget::Claude => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed shep claude hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no shep claude hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Codex => {
            ...
            if result.updated_hooks {
                messages.push(format!(
                    "removed shep codex hook entries from {}",
                    result.hooks_path.display()
                ));
            } else {
                messages.push(format!(
                    "no shep codex hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            messages.push(format!(
        ...
        crate::api::schema::IntegrationTarget::Copilot => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed shep copilot hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no shep copilot hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Devin => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed shep devin hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no shep devin hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Kimi => {
            ...
            if result.updated_config {
                messages.push(format!(
                    "removed shep kimi hook entries from {}",
                    result.config_path.display()
                ));
            } else {
                messages.push(format!(
                    "no shep kimi hook entries found in {}",
                    result.config_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Droid => {
            ...
            if result.updated_hooks {
                ...
                messages.push(format!(
                    "no legacy shep droid hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            if result.updated_settings {
                messages.push(format!(
                    "removed shep droid hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no shep droid hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Qodercli => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed shep qodercli hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no shep qodercli hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Cursor => {
            ...
            if result.updated_hooks {
                messages.push(format!(
                    "removed shep cursor hook entries from {}",
                    result.hooks_path.display()
                ));
            } else {
                messages.push(format!(
                    "no shep cursor hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Mastracode => {
            ...
            if result.updated_hooks {
                messages.push(format!(
                    "removed shep mastracode hook entries from {}",
                    result.hooks_path.display()
                ));
            } else {
                messages.push(format!(
                    "no shep mastracode hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            messages
