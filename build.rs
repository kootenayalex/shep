...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=SHEP_BUILD_CHANNEL");
    println!("cargo:rerun-if-env-changed=SHEP_BUILD_ID");
    println!("cargo:rerun-if-env-changed=SHEP_BUILD_COMMIT");
